...
TexasHoldemData::TexasHoldemData(int ipc, const std::vector<int>& initMoney, int sizeCount) {
    onTableMoneys.resize(sizeCount, 0);
    bAlive.resize(sizeCount, 0);
    moneys.resize(sizeCount, 0);
    thisTurnMoneys.resize(sizeCount, 0);
...
void TexasHoldemData::Bet(int n, int amount) {
    moneys.resize(n + 1, 0);
    thisTurnMoneys.resize(n + 1, 0);
    onTableMoneys.resize(n + 1, 0);
